...
const Contact = () => {
  ...
  return (
  <>
      <section class="w-5/6 md:w-3/4 mx-auto text-gray-600 body-font relative">
      <div class="container px-5 py-24 mx-auto">
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
              <button class="flex mx-auto text-white bg-slate-700 border-0 py-2 px-8 focus:outline-none hover:bg-teal-500 rounded text-lg">Send</button>
            </div>
            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a class="text-indigo-500">example@email.com</a>
              <p class="leading-normal my-5">49 Lorem St.
                <br/>Lorem Ipsum, MN 56301
              </p>
