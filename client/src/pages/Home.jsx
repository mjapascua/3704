...
function Home() {
  ...
  return (
    <>
      <main>
        <section classNameName="w-5/6 md:w-3/4 mx-auto text-gray-700 body-font">
          <div classNameName="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div classNameName="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <p className="mb-8 leading-relaxed">
                Here in ResPass - HOA Solutions, you can manage QR codes to
                allow people to visit you in your subdivision.
              </p>
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap -m-4">
              ...
              <div className="lg:w-1/3 sm:w-1/2 p-4">
                ...
                <section classNameName="text-gray-700 body-fontw-5/6 md:w-3/4 mx-auto">
                  <div classNameName="container px-5 py-24 mx-auto">
                    <div classNameName="flex flex-col text-center w-full mb-20">
                      <h1 classNameName="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">
                        Lorem Ipsum
                      </h1>
                      ...
                      <div classNameName="lg:w-1/3 sm:w-1/2 p-4">
                        <div classNameName="flex relative">
                          ...
                          <div classNameName="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                            <h2 classNameName="tracking-widest text-sm title-font font-medium text-teal-500 mb-1">
                              Lorem Ipsum
                            </h2>
