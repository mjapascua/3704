  ...
  return (
    <div className="  mb-8 mt-5 flex-col md:flex-row flex h-72 bg-slate-100 rounded ">
      ...
      <div className="flex flex-col ml-8 py-4 w-2/5">
        <span className="mb-5 mt-5 inline-block w-44 h-8 animate-heavy-pulse bg-slate-200"></span>
        <span className="mb-2 inline-block w-3/4 h-32 mt-4p animate-light-pulse bg-slate-200"></span>
